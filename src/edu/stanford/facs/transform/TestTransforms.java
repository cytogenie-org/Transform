...
public class TestTransforms
{
	...
	/**
	 * Test whether the specified {@link Transform} is invertible to the stated
	 * precision using pseudorandom data from the supplied distribution.
	 * 
	 * @param transform
	 * @param distribution
	 * @param precision
	 ...
	 * the stated tolerance using pseudorandom data from the supplied
	 * distribution. Precision is calculated as the tolerance times the slope of
	 * the inverse transform at a given point on the scale.
	 * 
	 * @param transform
	 * @param distribution
	 * @param tolerance
	...
	/**
	 * Test whether two arrays are equal to single precision accuracy. Used to
	 * test equivalence of sets of scale coordinates returned by
	 * {@link edu.stanford.facs.transform.Logicle#axisLabels()}.
	 * 
	 * @param actual
	 *          coordinate values returned
	 * @param expected
	 *          coordinate values
	 */
	...
	/**
	 * Test method for
	 * {@link edu.stanford.facs.transform.Logicle#solve(double,double)}. Test
	 * whether the solution found actually solves the problem.
	 */
	@Test
	...
	public void testLogicleScale ()
	{
		...
		logicle = new Logicle(1000, 0, 4.5, 0);
		testScale(logicle, normal, 2 * Math.ulp(1D));
		testScale(logicle, extended, 2 * Math.ulp(1D));
	}
	 ...
	 * . Check that the inverse function really is the inverse of the scale
	 * function
	 */
	@Test
	 ...
	 * Test whether the function returns the expected results in various
	 * circumstances.
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link edu.stanford.facs.transform.Hyperlog#inverse(double)}. Check that
	 * the inverse function really is the inverse of the scale function
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link edu.stanford.facs.transform.Logarithmic#scale(double)}. Test that
	 * the scale function really is the inverse of the biexponential
	 */
	@Test
	...
	/**
	 * Test method for
	 * {@link edu.stanford.facs.transform.Logarithmic#inverse(double)}. Check that
	 * the inverse function really is the inverse of the scale function
	 */
	@Test
	...
	public void testLinearInverse ()
	{
		...
		// log normally distributed data
		distribution =
				new LogNormal(Math.log(linear.T) / 4, Math.log(linear.T) / 6);
		testInverse(linear, distribution, 2 * Math.ulp(1D));
	}
}
